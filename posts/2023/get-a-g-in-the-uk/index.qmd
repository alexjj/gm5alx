...
You can get all the G# except G2, and they also no longer give out 2 letter callsigns, e.g. G3DX[^1]. You can only get a two letter callsign one is given to you. This is typically if a relative of the original holder (who is now sk) writes a letter or does something that convinces ofcom to give it to you. The original holder doesn’t necessarily need to be a relative of yours, but perhaps the story has to be somewhat more convincing.
