...
On the G90 (I have firmware 1.78 so no U-D data mode), put the audio to line in with Fn+Power button, turn off compressor, turn off Preamo, and push the volume knob so it switches to headphones (unless you like listening to data modes!). There are some other recommended settings [from the internet](https://www.digitalshack.org/xiegu-g90-ft8/) in the menu. Not sure how important they really are but I set them anyway:
