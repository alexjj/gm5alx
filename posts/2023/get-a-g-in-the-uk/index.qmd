...
::: {.callout-important}
This process is now a lot simpler and you can just go to the ofcom website and see all the prefixes and find the callsign you want, without extra searches or using the "paper" form.
:::
